export class LauncherConfig 
{
    ...
    static INTERVAL_CHECK_FOR_PATCH_TO_DL : number = 500; // orig
    ...
    static INTERVAL_CHECK_FOR_NEW_REMOTE_FILES : number = 2500; //orig
    
    // How often the launcher updates news (MS).
    static INTERVAL_CHECK_FOR_NEWS : number = 1000; //orig
